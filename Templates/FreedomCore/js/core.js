require = function e(t, n, r) {
    ...
    1: [function(e, t, n) {
        (function(t) {
            t.Core = e("@freedomnet/core-client"), t.Marketing = e("@freedomnet/analytics-client")
        }).call(this, "undefined" != typeof global ? global : "undefined" != typeof self ? self : "undefined" != typeof window ? window : {})
    }, {
        "@freedomnet/analytics-client": "@freedomnet/analytics-client",
        "@freedomnet/core-client": "@freedomnet/core-client"
    }],
    2: [function(e, t, n) {
        var r = e("./util"),
            i = (e("jquery"), {
                ...
                create: function(e, t, n) {
                    ...
                    var o = n.expires;
                    o = "number" == typeof n.expires ? n.expires : 1, n.expires = new Date, n.expires.setTime(n.expires.getTime() + 36e5 * o);
                    var a = [encodeURIComponent(e) + "=", n.escape ? encodeURIComponent(t) : t, "; expires=" + n.expires.toUTCString(), n.path ? "; path=" + n.path : "", n.domain ? "; domain=" + n.domain : "", n.secure ? "; secure" : ""];
                    document.cookie = a.join(""), i.cache && (n.expires.getTime() < (new Date).getTime() ? delete i.cache[e] : i.cache[e] = t)
                },
                read: function(e) {
    ...
    4: [function(e, t, n) {
        var r = e("@freedomnet/core-client"),
            i = e("jquery"),
            o = {
                initialized: !1,
                element: null,
                ...
                initialize: function() {
                    o.element = i("<div/>", {
                        id: "blackout"
                    }), o.element.on("click", r.stopPropagation).on("keyup", o.listen), i("body").append(o.element), o.initialized = !0
                },
                listen: function(e) {
                    e.which === KeyCode.esc && o.hide()
                },
                show: function(e, t, n) {
                    o.initialized || o.initialize(), r.isIE() && (o.element.css("width", Page.dimensions.width).css("height", i(document).height()), "ie6" === r.browser.full && (o.shim.css("width", o.element.css("width")).css("height", o.element.css("height")), r.isCallback(t) && (o.shim[0].contentWindow.document.onclick = t))), n && o.element.addClass("blackout-transparent"), o.element.show(), r.isCallback(e) && e(), r.isCallback(t) && o.element.click(t)
                },
                hide: function(e) {
                    o.element.hide(), r.isCallback(e) && e(), o.element.unbind("click").removeClass("blackout-transparent")
                }
            };
        t.exports = o
    }, {
    ...
    "@freedomnet/analytics-client": [function(e, t, n) {
        var r = e("@freedomnet/core-client"),
            i = e("jquery"),
            o = {
                bindTracking: function(e, t, n) {
                    i(e).click(function() {
                        var e = i(this);
                        try {
                            _gaq.push(["_trackEvent", e.data("category") || t, e.data("action") || n, e.data("ad") + " [" + r.locale + "]"])
                        } catch (o) {}
                    })
                },
                trackActivity: function(e, t) {
                    try {
                        _gaq.push(["_trackEvent", "Battle.net User Activity", e, t + " [" + r.locale + "]"])
                    } catch (n) {}
                },
                trackAd: function(e, t, n, i) {
                    try {
                        n = n ? n + " - " : "", _gaq.push(["_trackEvent", "Battle.net Ad Service", i ? "Ad Click-Throughs" : "Ad Impressions", "Ad " + encodeURIComponent(t.replace(" ", "_")) + " - " + n + r.locale + " - " + e])
                    } catch (o) {}
                },
    ...
    "@freedomnet/core-client": [function(e, t, n) {
        var r = e("jquery"),
            i = e("@freedomnet/cookie-client");
        ! function() {
            var e = !1,
                t = /xyz/.test(function() {
                    xyz
            ...
            window.Class = function() {}, Class.extend = function(n) {
                ...
                var o = new this;
                e = !1;
                for (var a in n) o[a] = "function" == typeof n[a] && "function" == typeof i[a] && t.test(n[a]) ? function(e, t) {
                    return function() {
                        var n = this._super;
                        this._super = i[e];
                ...
                return r.prototype = o, r.constructor = r, r.extend = this.callee || arguments.callee, r
            }
        }();
        var o = {
            baseUrl: "/",
            ...
            userAgent: "web",
            initialize: function() {
                o.processLoadQueue(), o.ui(), o.host = location.protocol + "//" + (location.host || location.hostname);
                var e = r("html"),
                    t = o.getBrowser();
                "" !== t.name && (e.addClass(t.name).addClass(t.full), "ie" !== t.name || 6 !== t.version && 7 !== t.version || e.addClass("ie67"))
            },
            alpha: function(e) {
                return e.replace(/[^a-zA-Z]/gi, "")
            },
            appendFrame: function(e, t, n, i, a) {
                "undefined" != typeof e && ("undefined" == typeof t && (t = 1), "undefined" == typeof n && (n = 1), "undefined" == typeof i && (i = r("body")), i.append(o.isIE() ? '<iframe src="' + e + '" width="' + t + '" height="' + n + '" scrolling="no" frameborder="0" allowTransparency="true"' + ("undefined" != typeof a ? ' id="' + a + '"' : "") + "></iframe>" : '<object type="text/html" data="' + e + '" width="' + t + '" height="' + n + '"' + ("undefined" != typeof a ? ' id="' + a + '"' : "") + "></object>"))
            },
            ...
            formatDatetime: function(e, t) {
                var n;
                if (t) {
                    if (n = new Date(t), isNaN(n.getTime()) && (t = t.substring(0, 10) + " " + t.substring(11, 16) + ":00 GMT" + t.substring(16, 19) + t.substring(20, 22), n = new Date(t)), isNaN(n.getTime()) && (t = t.substring(0, 4) + "/" + t.substring(5, 7) + "/" + t.substring(8, 29), n = new Date(t)), isNaN(n.getTime()) && (t = t.substring(5, 10) + " " + t.substring(11, 16) + " GMT" + t.substring(23, 28) + " " + t.substring(0, 4), n = new Date(t)), isNaN(n.getTime())) return !1
                } else n = new Date;
                e || (e = "yyyy-MM-ddThh:mmZ");
                var r = n.getHours(),
                    i = "AM";
                r > 12 ? (r -= 12, i = "PM") : 12 === r ? i = "PM" : 0 === r && (r = 12);
                var a = parseInt(n.getTimezoneOffset() / 60 * -1, 10);
                return a = 0 > a ? "-" + o.zeroFill(Math.abs(a), 2) + ":00" : " + " + o.zeroFill(Math.abs(a), 2) + ":00", e = e.replace("yyyy", n.getFullYear()), e = e.replace("MM", o.zeroFill(n.getMonth() + 1, 2)), e = e.replace("dd", o.zeroFill(n.getDate(), 2)), e = e.replace("HH", o.zeroFill(n.getHours(), 2)), e = e.replace("hh", o.zeroFill(r, 2)), e = e.replace("mm", o.zeroFill(n.getMinutes(), 2)), e = e.replace("a", i), e = e.replace("Z", a)
            },
            getBrowser: function() {
                ...
                var e = r.support,
                    t = "",
                    n = 0;
                return e.hrefNormalized || e.tbody || e.style || e.opacity ? e.hrefNormalized && e.tbody && e.style && !e.opacity ? (t = "ie", n = 8) : "undefined" != typeof r.browser && (r.browser.mozilla ? t = "ff" : r.browser.msie ? t = "ie" : r.browser.webkit ? t = navigator.userAgent.toLowerCase().indexOf("chrome") >= 0 ? "chrome" : "safari" : r.browser.opera && (t = "opera"), n = parseInt(r.browser.version, 10)) : "undefined" != typeof document.body.style.maxHeight || window.XMLHttpRequest ? (t = "ie", n = 7) : (t = "ie", n = 6), o.browser = {
                    name: t,
                    full: t + n,
                    version: n
                }, o.browser
            ...
            goTo: function(e, t) {
                window.location.href = (t ? o.baseUrl : "") + e, window.event && (window.event.returnValue = !1)
            },
            ...
            load: function(e, t, n) {
                t = t !== !1, Page.loaded || !t ? o.loadDeferred(e, n) : o.deferredLoadQueue.push(e)
            },
            ...
            loadDeferredStyle: function(e, t) {
                r("head").append('<link rel="stylesheet" href="' + e + '" type="text/css" media="' + (t || "all") + '" />')
            },
            msg: function(e) {
                for (var t = 1, n = arguments.length; n > t; ++t) e = e.replace("{" + (t - 1) + "}", arguments[t]);
                return e
            },
            msgAll: function(e) {
                for (var t = 1, n = arguments.length; n > t; ++t) e = e.replace(new RegExp("\\{" + (t - 1) + "\\}", "g"), arguments[t]);
                return e
            },
            numeric: function(e) {
            ...
            scrollTo: function(e, t, n) {
                if (e = r(e), 1 === e.length) {
                    var i = r(window),
                        ...
                        a = o + i.height(),
                        s = e.offset().top;
                    s -= 15, s >= o && a >= s || "undefined" != typeof r.browser && r(r.browser.webkit ? "body" : "html").animate({
                        scrollTop: s
                    }, t || 350, n || null)
                }
            },
            scrollToVisible: function(e, t, n) {
                if (e = r(e), 1 === e.length) {
                    var i = r(window),
                        ...
                        s = e.offset().top,
                        l = s + e.height();
                    s -= 15, l += 15, s >= o && a >= l || "undefined" != typeof r.browser && r(r.browser.webkit ? "body" : "html").animate({
            ...
            trimChar: function(e, t) {
                return e.substr(0, 1) === t && (e = e.substr(1, e.length - 1)), e.substr(e.length - 1, e.length) === t && (e = e.substr(0, e.length - 1)), e
            },
            trimRight: function(e, t) {
                return t = t ? (t + "").replace(/([\[\]\(\)\.\?\/\*\{\}\+\$\^\:])/g, "\\$1") : " \\sВ ", (e + "").replace(new RegExp("[" + t + "]+$", "g"), "")
            },
            ui: function(e) {
                e = e || document, o.isIE(6) && r(e).find("button.ui-button").hover(function() {
                    this.disabled && -1 != this.className.indexOf("disabled") || r(this).addClass("hover")
                }, function() {
                    r(this).removeClass("hover")
                }), "bam" !== o.project && r(e).find("button.ui-button").click(function(e) {
                    var t = r(this),
                        n = t.attr("data-text");
                    return "undefined" == typeof n && (n = ""), "button" === this.tagName.toLowerCase() && "" !== n && "submit" === t.attr("type") && (e.preventDefault(), e.stopPropagation(), t.find("span span").html(n), t.removeClass("hover").addClass("processing").attr("disabled", "disabled"), t.parents("form").submit()), !0
                })
            },
            zeroFill: function(e, t, n) {
                ...
                var r = parseFloat(e),
                    ...
                    a = o - 1;
                if (0 > r && (r = Math.abs(r), i = !0, o++, a = o - 1), t > 0 && (r.toString().indexOf(".") > 0 && (n || (o += r.toString().split(".")[1].length), o++, a = o - 1), a >= 0))
                    do r = "0" + r; while (a--);
                return i ? "-" + r : r
            },
            ...
            bindTrackEvent: function(e, t, n, i) {
                r(e).on("click.analytics", function() {
                    var e, a, s, l = r(this);
                    if (e = "function" == typeof t ? t.call(this) : t, s = "function" == typeof i ? i.call(this) : i, "function" == typeof n) {
                        var u = l.data("action-attachment") || "Unknown Action";
                        a = n.call(this, u)
                    } else a = n;
                    e = l.data("category") || e || o.project, a = l.data("action") || a || "Click", s = l.data("label") || s || o.locale, o.trackEvent(e, a, s)
                })
            },
            showUntilClosed: function(e, t, n) {
                ...
                return a.delegate("a", "click", function() {
                    var e = r(this),
                        t = e.data("label"),
                        o = "close" === this.rel;
                    o && (a.hide(), n.onHide && n.onHide()), (o || !n.closeButtonOnly) && i.create(s, 1, d), t && Marketing.trackImpression(n.trackingCategory || "Tracking", n.trackingAction || "Click", t)
                }), !0
            }
        };
        t.exports = o
    }, {
        "@freedomnet/cookie-client": 2,
        jquery: "jquery"
    }],
    "@freedomnet/login-client": [function(e, t, n) {
        var r = e("@freedomnet/core-client"),
            i = e("@freedomnet/blackout-client"),
            o = e("jquery"),
            a = {
                ...
                success: function(e) {
                    o("<div/>", {
                        ...
                        if (0 === window.location.hash.length) window.location = window.location + t + "ST=" + e;
                        else {
                            var n = window.location.href.substring(0, window.location.href.length - window.location.hash.length);
                            window.location = n + t + "ST=" + e + "&ST-frag=" + window.location.hash.substring(1)
                        }
                    }, 100)
                },
                open: function(e, t, n) {
                    e = e || a.embeddedUrl;
                    var i = -1 === e.indexOf("?") ? "?" : "&";
                    if ("https:" === document.location.protocol && (e += i, e += "secureOrigin=true", i = "&"), (-1 === e.indexOf("?loc=") || -1 === e.indexOf("&loc=")) && (e += i + "loc=" + r.getLanguage(), i = "&"), (-1 === e.indexOf("?ref=") || -1 === e.indexOf("&ref=")) && (e += i + "ref=" + encodeURIComponent(window.location), i = "&"), document.getElementById(a.CONTAINER_ID)) return !1;
                    var o = -1 === n.indexOf("?") ? "?" : "&";
                    return document.location = t + encodeURIComponent(n + o + "ST-frag=" + encodeURIComponent(r.getHash())), !1
                },
                ...
                _close: function(e) {
                    a._removeListener(), e = e || !1, o("#" + a.CONTAINER_ID).fadeOut(a.FADE_DURATION, function() {
                ...
                _messageListener: function(e) {
                    ...
                    switch (t.action) {
                        case "onload":
                            ...
                            n.css("height", t.height), r.css("height", t.height), t.height > 500 && (n.css("margin-top", -(t.height / 2)), n.css("margin-bottom", -(t.height / 2))), n.css("visibility", "visible");
                            break;
                        case "success":
                ...
                _setListener: function() {
                    ...
                    }, "undefined" != typeof addEventListener ? addEventListener("message", a._listener, !1) : attachEvent("onmessage", a._listener)
                },
                _removeListener: function() {
                    a._listener && ("undefined" != typeof removeEventListener ? removeEventListener("message", a._listener, !1) : detachEvent("onmessage", a._listener))
                },
                _timeTracker: {
                    startTime: null,
                    start: function() {
                        ...
                        _gaq.push(["_trackEvent", "debug", "login frag load time", "" + 500 * Math.round(((new Date).getTime() - this.startTime) / 500)])
                    }
                },
                _timeoutHandler: {
                    timeoutMs: 5e3,
                    ...
                    deactivate: function() {
                        this.loaderVar.remove(), window.clearTimeout(this.timeoutVar), this.timeoutVar = null
                    },
                    handleTimeout: function() {
                        _gaq.push(["_trackEvent", "debug", "login frag timeout", "" + this.timeoutMs]), window.location = "/?login"
                    }
                }
            };
        t.exports = a
    }, {
        "@freedomnet/blackout-client": 4,
        "@freedomnet/core-client": "@freedomnet/core-client",
        jquery: "jquery"
    }],
        ...
        ! function(e, n) {
            ...
            function M(e, t, n) {
                ...
                if (ie.isEmptyObject(f)) "inline" === ("none" === u ? N(e.nodeName) : u) && (p.display = u);
                    ...
                    for (r in f) a = z(h ? m[r] : 0, r, d), r in m || (m[r] = a.start, h && (a.end = a.start, a.start = "width" === r || "height" === r ? 1 : 0))
                }
            }
            ...
            function F(e, t, n) {
                ...
                return ie.map(c, z, u), ie.isFunction(u.opts.start) && u.opts.start.call(e, u), ie.fx.timer(ie.extend(l, {
                    elem: e,
                    anim: u,
                    queue: u.opts.queue
            ...
            var ue = function(e) {
                ...
                function p(e, t, n) {
                    ...
                    return t.first ? function(t, n, o) {
                        ...
                        if (a) {
                            ...
                            for (; t = t[r];)
                                if (1 === t.nodeType || i) {
                                    if (l = t[R] || (t[R] = {}), (s = l[r]) && s[0] === I && s[1] === o) return u[2] = s[2];
                ...
                var x, w, T, C, k, N, E, S, D, A, j, L, _, H, q, z, M, O, F, R = "sizzle" + -new Date,
                    B = e.document,
                    I = 0,
                    P = 0,
                    W = n(),
                ...
                w = t.support = {}, k = t.isXML = function(e) {
                    ...
                    var t, n = e ? e.ownerDocument || e : B,
                        r = n.defaultView;
                    return n !== _ && 9 === n.nodeType && n.documentElement ? (_ = n, H = n.documentElement, q = !k(n), r && r !== r.top && (r.addEventListener ? r.addEventListener("unload", function() {
                        L()
                        ...
                        }, M = [], z = [], (w.qsa = ve.test(n.querySelectorAll)) && (i(function(e) {
                        e.innerHTML = "<select msallowclip=''><option selected=''></option></select>", e.querySelectorAll("[msallowclip^='']").length && z.push("[*^$]=" + re + "*(?:''|\"\")"), e.querySelectorAll("[selected]").length || z.push("\\[" + re + "*(?:value|" + ne + ")"), e.querySelectorAll(":checked").length || z.push(":checked")
                    }), i(function(e) {
                        var t = n.createElement("input");
                        t.setAttribute("type", "hidden"), e.appendChild(t).setAttribute("name", "D"), e.querySelectorAll("[name=d]").length && z.push("name" + re + "*[*^$|!~]?="), e.querySelectorAll(":enabled").length || z.push(":enabled", ":disabled"), e.querySelectorAll("*,:x"), z.push(",.*:")
                    })), (w.matchesSelector = ve.test(O = H.matches || H.webkitMatchesSelector || H.mozMatchesSelector || H.oMatchesSelector || H.msMatchesSelector)) && i(function(e) {
                        w.disconnectedMatch = O.call(e, "div"), O.call(e, "[s!='']:x"), M.push("!=", se)
                    }), z = z.length && new RegExp(z.join("|")), M = M.length && new RegExp(M.join("|")), t = ve.test(H.compareDocumentPosition), F = t || ve.test(H.contains) ? function(e, t) {
                        ...
                        return r ? r : (r = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & r || !w.sortDetached && t.compareDocumentPosition(e) === r ? e === n || e.ownerDocument === B && F(B, e) ? -1 : t === n || t.ownerDocument === B && F(B, t) ? 1 : A ? te.call(A, e) - te.call(A, t) : 0 : 4 & r ? -1 : 1)
                    } : function(e, t) {
                        if (e === t) return j = !0, 0;
                        var r, i = 0,
                            o = e.parentNode,
                    ...
                    if ((e.ownerDocument || e) !== _ && L(e), n = n.replace(de, "='$1']"), !(!w.matchesSelector || !q || M && M.test(n) || z && z.test(n))) try {
                        var r = O.call(e, n);
                    ...
                    var t, n = [],
                        r = 0,
                        i = 0;
                    if (j = !w.detectDuplicates, A = !w.sortStable && e.slice(0), e.sort(X), j) {
                            ...
                            return 1 === r && 0 === i ? function(e) {
                                ...
                                if (g) {
                                    ...
                                    if (h = [a ? g.firstChild : g.lastChild], a && y) {
                                        for (c = g[R] || (g[R] = {}), u = c[e] || [], p = u[0] === I && u[1], f = u[0] === I && u[2], d = p && g.childNodes[p]; d = ++p && d && d[m] || (f = p = 0) || h.pop();)
                                            if (1 === d.nodeType && ++f && d === t) {
                                                c[e] = [I, p, f];
                                                break
                                            }
                                    } else if (y && (u = (t[R] || (t[R] = {}))[e]) && u[0] === I) f = u[1];
                                    else
                                        for (;
            ...
            ie.event = {
                ...
                add: function(e, t, n, r, i) {
                    ...
                    if (g) {
                        ...
                        }, c.elem = e), t = (t || "").match(be) || [""], s = t.length; s--;) o = ze.exec(t[s]) || [], p = m = o[1], h = (o[2] || "").split(".").sort(), p && (u = ie.event.special[p] || {}, p = (i ? u.delegateType : u.bindType) || p, u = ie.event.special[p] || {}, d = ie.extend({
                            type: p,
                            origType: m,
                            data: r,
                            handler: n,
                ...
                trigger: function(t, n, r, i) {
                    ...
                    if (s = c = r = r || he, 3 !== r.nodeType && 8 !== r.nodeType && !qe.test(p + ie.event.triggered) && (p.indexOf(".") >= 0 && (h = p.split("."), p = h.shift(), h.sort()), a = p.indexOf(":") < 0 && "on" + p, t = t[ie.expando] ? t : new ie.Event(p, "object" == typeof t && t), t.isTrigger = i ? 2 : 3, t.namespace = h.join("."), t.namespace_re = t.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = r), n = null == n ? [t] : ie.makeArray(n, [t]), u = ie.event.special[p] || {}, i || !u.trigger || u.trigger.apply(r, n) !== !1)) {
                        ...
                        for (d = 0;
                             (s = f[d++]) && !t.isPropagationStopped();) t.type = d > 1 ? l : u.bindType || p,
                            o = (ie._data(s, "events") || {})[t.type] && ie._data(s, "handle"), o && o.apply(s, n), o = a && s[a], o && o.apply && ie.acceptData(s) && (t.result = o.apply(s, n), t.result === !1 && t.preventDefault());
                ...
                fix: function(e) {
                    ...
                    var t, n, r, i = e.type,
                        o = e,
                        a = this.fixHooks[i];
                    for (a || (this.fixHooks[i] = a = He.test(i) ? this.mouseHooks : _e.test(i) ? this.keyHooks : {}), r = a.props ? this.props.concat(a.props) : this.props, e = new ie.Event(o), t = r.length; t--;) n = r[t], e[n] = o[n];
            ...
            Ye.optgroup = Ye.option, Ye.tbody = Ye.tfoot = Ye.colgroup = Ye.caption = Ye.thead, Ye.th = Ye.td, ie.extend({
                clone: function(e, t, n) {
                    ...
                    if (ne.html5Clone || ie.isXMLDoc(e) || !Fe.test("<" + e.nodeName + ">") ? o = e.cloneNode(!0) : (Ge.innerHTML = e.outerHTML, Ge.removeChild(o = Ge.firstChild)), !(ne.noCloneEvent && ne.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || ie.isXMLDoc(e)))
                    ...
                    for (var i, o, a, s, l, u, c, d = e.length, f = m(t), p = [], h = 0; d > h; h++)
                        if (o = e[h], o || 0 === o)
                            if ("object" === ie.type(o)) ie.merge(p, o.nodeType ? [o] : o);
                                ...
                                for (s = s || f.appendChild(t.createElement("div")), l = (Ie.exec(o) || ["", ""])[1].toLowerCase(), c = Ye[l] || Ye._default, s.innerHTML = c[1] + o.replace(Be, "<$1></$2>") + c[2], i = c[0]; i--;) s = s.lastChild;
                                if (!ne.leadingWhitespace && Re.test(o) && p.push(t.createTextNode(Re.exec(o)[0])), !ne.tbody)
                                    for (o = "table" !== l || Pe.test(o) ? "<table>" !== c[1] || Pe.test(o) ? 0 : s : s.firstChild, i = o && o.childNodes.length; i--;) ie.nodeName(u = o.childNodes[i], "tbody") && !u.childNodes.length && o.removeChild(u);
                ...
                html: function(e) {
                    return Ae(this, function(e) {
                        ...
                        if (!("string" != typeof e || $e.test(e) || !ne.htmlSerialize && Fe.test(e) || !ne.leadingWhitespace && Re.test(e) || Ye[(Ie.exec(e) || ["", ""])[1].toLowerCase()])) {
                            e = e.replace(Be, "<$1></$2>");
                            try {
            ...
            ie.extend({
                ...
                run: function(e) {
                    ...
                    return this.pos = t = this.options.duration ? ie.easing[this.easing](e, this.options.duration * e, 0, 1, this.options.duration) : e, this.now = (this.end - this.start) * t + this.start, this.options.step && this.options.step.call(this.elem, this.now, this), n && n.set ? n.set(this) : _.propHooks._default.set(this), this
                }
            ...
            ie.fn.extend({
                ...
                removeAttr: function(e, t) {
                    var n, r, i = 0,
                        o = t && t.match(be);
                    if (o && 1 === e.nodeType)
                        for (; n = o[i++];) r = ie.propFix[n] || n, ie.expr.match.bool.test(n) ? Et && Nt || !kt.test(n) ? e[r] = !1 : e[ie.camelCase("default-" + n)] = e[r] = !1 : ie.attr(e, n, ""), e.removeAttribute(Nt ? n : r)
                },
                attrHooks: {
                    type: {
                        set: function(e, t) {
            ...
            Ht = It.exec(qt.toLowerCase()) || [], ie.extend({
                active: 0,
                lastModified: {},
                etag: {},
                ajaxSettings: {
                ...
                ajax: function(e, t) {
                    ...
                    if (h.promise(w).complete = m.add, w.success = w.done, w.error = w.fail, d.url = ((e || d.url || qt) + "").replace(zt, "").replace(Bt, Ht[1] + "//"), d.type = t.method || t.type || d.method || d.type, d.dataTypes = ie.trim(d.dataType || "*").toLowerCase().match(be) || [""], null == d.crossDomain && (r = It.exec(d.url.toLowerCase()), d.crossDomain = !(!r || r[1] === Ht[1] && r[2] === Ht[2] && (r[3] || ("http:" === r[1] ? "80" : "443")) === (Ht[3] || ("http:" === Ht[1] ? "80" : "443")))), d.data && d.processData && "string" != typeof d.data && (d.data = ie.param(d.data, d.traditional)), B(Pt, d, t, w), 2 === b) return w;
                    l = d.global, l && 0 === ie.active++ && ie.event.trigger("ajaxStart"), d.type = d.type.toUpperCase(), d.hasContent = !Rt.test(d.type), o = d.url, d.hasContent || (d.data && (o = d.url += (Lt.test(o) ? "&" : "?") + d.data, delete d.data), d.cache === !1 && (d.url = Mt.test(o) ? o.replace(Mt, "$1_=" + jt++) : o + (Lt.test(o) ? "&" : "?") + "_=" + jt++)), d.ifModified && (ie.lastModified[o] && w.setRequestHeader("If-Modified-Since", ie.lastModified[o]), ie.etag[o] && w.setRequestHeader("If-None-Match", ie.etag[o])), (d.data && d.hasContent && d.contentType !== !1 || t.contentType) && w.setRequestHeader("Content-Type", d.contentType), w.setRequestHeader("Accept", d.dataTypes[0] && d.accepts[d.dataTypes[0]] ? d.accepts[d.dataTypes[0]] + ("*" !== d.dataTypes[0] ? ", " + $t + "; q=0.01" : "") : d.accepts["*"]);
            ...
            ie.param = function(e, t) {
                ...
                serializeArray: function() {
                    return this.map(function() {
                        ...
                        var e = this.type;
                        return this.name && !ie(this).is(":disabled") && Jt.test(this.nodeName) && !Yt.test(e) && (this.checked || !je.test(e))
                    }).map(function(e, t) {
                        var n = ie(this).val();
